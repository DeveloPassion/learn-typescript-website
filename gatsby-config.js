  ...
  plugins: [
    ...
    // reference: https://www.gatsbyjs.org/packages/gatsby-plugin-manifest
    {
      ...
      options: {
        ...
        theme_color: "#2a2f4a",
        display: "minimal-ui",
        icon: "src/assets/images/typescript.png", // This path is relative to the root of the site.
    ...
    // reference: https://www.gatsbyjs.org/packages/gatsby-plugin-google-analytics/
    {
      ...
      options: {
        ...
        //cookieDomain: "learn-typescript.dev", // auto
      },
    },
  ],
};
